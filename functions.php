...
function acamar_enqueue_scripts(){
    ...
    wp_register_script('bootstrap-js',get_template_directory_uri().'/assets/src/library/js/bootstrap.min.css',[],filemtime(get_template_directory().'/assets/main.js'),true);
